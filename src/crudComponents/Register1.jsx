...
function Register1({ Adduser }) {
    ...
    return (<>
        <div className="container-fluid bg-dark text-white register_page" id='register_page'>
            <div className="row">
                <img className='img-fluid col-md-5 d-none d-md-block ' src="https://post.bark.co/wp-content/uploads/2022/05/iStock-1328279493-1024x682.jpg" alt="none" />
                <div className="col-lg-6 col-md p-5 align-self-center d-flex flex-column">
                    ...
                    <div className="text-center">
                        <Link to='/login1' className=" small text-white text-decoration-none" >login an Existing Account!</Link>
                    </div>
